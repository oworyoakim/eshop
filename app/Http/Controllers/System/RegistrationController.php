 ...
 * @author Yoakim
 */
class RegistrationController extends SystemBaseController {
    ...
    private function sendActivationEmail($user, $activationCode) {
        ...
        $company_otheremail = Setting::where('setting_key', 'company_otheremail')->first()->setting_value;
        $subject = Setting::where('setting_key', 'account_registration_email_subject')->first()->setting_value;
