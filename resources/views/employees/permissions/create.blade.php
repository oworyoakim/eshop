...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                @if(Sentinel::hasAccess('employees.permissions'))
                    <a href="{{url('manager/employees/permissions')}}" class="pull-right btn btn-default btn-sm"><i
                                class="fa fa-backward"></i>&nbsp; {{trans_choice('general.back',2)}}</a>
                @endif
            </div>
        </div>
        {!! Form::open(array('url' => 'manager/employees/permissions/create','class'=>'',"enctype" => "multipart/form-data")) !!}
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
        ...
        <div class="box-footer">
            @if(Sentinel::hasAccess('employees.permissions'))
                <a href="{{url('manager/employees/permissions')}}"
