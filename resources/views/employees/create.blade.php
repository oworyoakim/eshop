...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                @if(Sentinel::hasAnyAccess(['employees','employees.view']))
                    <a href="{{url('manager/employees')}}" class="pull-right btn btn-default btn-sm"><i
                                class="fa fa-backward"></i>&nbsp; {{trans_choice('general.back',2)}}</a>
                @endif
            </div>
        </div>
        {!! Form::open(array('url' => url('manager/employees/create'), 'method' => 'post', 'name' => 'form',"enctype"=>"multipart/form-data")) !!}
        <div class="box-body">
            <div class="col-md-12">
                @if(is_null($branch))
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('phone',null, array('class' => 'form-control','placeholder'=>trans_choice('general.phone',2),'required'=>'required')) !!}
                </div>
                <div class="form-group">
        ...
        <div class="box-footer">
            @if(Sentinel::hasAnyAccess(['employees','employees.view']))
                <a href="{{url('manager/employees')}}" class="btn btn-default btn-sm">{{trans_choice('general.cancel',1)}}</a>
            @endif
