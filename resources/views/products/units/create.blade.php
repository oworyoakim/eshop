@extends('layoutnew')
@section('title')
    {{trans_choice('general.add',1)}} {{trans_choice('general.new',1)}} {{trans_choice('general.unit',1)}}
@endsection
@section('content')
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                @if(Sentinel::hasAccess('products.units.view'))
                    <a href="{{url('manager/products/units')}}" class="btn btn-default btn-sm pull-right">
                        <i class="fa fa-backward"></i>&nbsp; {{trans_choice('general.back',2)}}
                    </a>
                @endif
            </div>
        </div>
        {!! Form::open(array('url' => url('manager/products/units/create'), 'method' => 'post', 'name' => 'form',"enctype"=>"")) !!}
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                {!! Form::text('title',null, array('class' => 'form-control','placeholder'=>trans_choice('general.title',1),'required'=>'required','onkeyup'=>'onTitleKeyup(event);')) !!}
            </div>

            <div class="form-group">
                {!! Form::label('slug',trans_choice('general.slug',1),array('class'=>'')) !!}
                {!! Form::text('slug',null, array('class' => 'form-control', 'placeholder'=>trans_choice('general.slug',1),'required'=>'required')) !!}
            </div>
        ...
        <div class="box-footer">
            @if(Sentinel::hasAccess('products.units.view'))
                <a href="{{url('manager/products/units')}}"
