        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                @if(Sentinel::hasAccess('users.roles'))
                    <a href="{{url('admin/users/roles')}}" class="pull-right btn btn-default btn-sm"><i
                                class="fa fa-backward"></i>&nbsp; {{trans_choice('general.back',2)}}</a>
                @endif
            </div>
        </div>
        {!! Form::open(array('url' => 'admin/users/roles/update/'.$role->id,'class'=>'',"enctype" => "multipart/form-data")) !!}
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
