...
@section('content')
    <div class="row">
        ...
        <div class="col-xl-4 col-md-4 col">
            <div class="info-box">
                <span class="info-box-icon bg-success"><i class="fa fa-balance-scale"></i></span>

                <div class="info-box-content">
                    <span class="info-box-number">{{count($expenses)}}</span>
                    <span class="info-box-text">{{trans_choice('general.expense',2)}} {{trans_choice('general.unit',2)}}</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-xl-4 col-md-4 col">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-number">{{count($sales_returns)}}</span>
